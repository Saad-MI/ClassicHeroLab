...
class Hero{
    ...
    public:
        ...
        void couragesetter(int currentcourage) {
...
void quest(Hero& hero1) {
    int Monsterstrength = (rand() % 71) + 50;
...
int main()
{
    ...
    cout << endl;
    cout << hero1.getname() << " went on a quest!" << endl;
    ...
    cout << endl;
    cout << hero2.getname() << " went on a quest!" << endl;
    ...
    cout << endl;
    cout << hero3.getname() << " went on a quest!" << endl;
